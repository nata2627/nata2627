...
В ML — полный исследовательский цикл: от сбора и разметки корпуса до дообучения языковой модели с измеримыми результатами. Контрибьютор фреймворков для работы с LLM и RAG. Отдельно — шесть лет прикладной аналитической практики: эконометрическое моделирование, оценка бизнеса, анализ ценных бумаг.
