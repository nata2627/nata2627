...
**Аналитик на стыке экономики и машинного обучения.**

Финансовый университет при Правительстве РФ: бакалавриат «Экономика» по программе «Оценка бизнеса в цифровой экономике» и магистратура «Прикладная математика и информатика» по программе «Машинное обучение на текстах и графах» — оба диплома с отличием.

Шесть лет прикладной аналитической практики: эконометрическое моделирование, оценка бизнеса, анализ ценных бумаг. В ML — полный исследовательский цикл от сбора корпуса до дообучения языковой модели с измеримым результатом.
...
| [deepset-ai/haystack](https://github.com/deepset-ai/haystack/pulls?q=author%3Anata2627) | Оркестрация LLM-пайплайнов | PR по обработке ошибок и оптимизации хранилища |
...
**Эконометрика** МНК · панельные данные · ARIMA/GARCH · логит/пробит · проверка гипотез · A/B-тесты
